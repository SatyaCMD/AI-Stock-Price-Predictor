...
export default function DownloadButton({ stockData, predictions }) {
    ...
    const generatePDF = async (userName) => {
        ...
        try {
            ...
            addInteractiveLogoToPage(doc, pageWidth, appLogoDataUrl);
            doc.setFontSize(18);
            doc.text("Appendix: Historical Data", 14, 20);
            ...
            doc.setFontSize(10);
            doc.text("This report is generated by AI for informational purposes only. It does not constitute financial advice. Trading stocks involves risk. Please consult a qualified financial advisor before making investment decisions.", 14, 30, { maxWidth: pageWidth - 28 });
